...
_bannedWeapons = [
    ...
    "CRV7_PG","CTWS","D10","D30","D81","DT_veh","GAU8","GRAD","GSh23L",
    ...
    "M134_2","M168","M242","M242BC","M252","M256","M2BC","M32_heli","M3P","M621",
...
_bannedVehicles = [
	"A10","AV8B","CruiseMissile1","CruiseMissile2","RM70_ACR","T810_Des_ACR","T810_ACR","T810Reammo_ACR",
    "Ka52Black","MQ9PredatorB","Mi24_D","Pchela1T","Su25_CDF","Su25_Ins","Su39","Su25_TK_EP1","Mi24_D_TK_EP1","T810Reammo_Des_ACR",
    ...
    "BRDM2_ATGM_CDF","BRDM2_ATGM_INS","BRDM2_CDF","BRDM2_HQ_Gue","BRDM2_INS","BTR90_HQ","GRAD_CDF","T810A_MG_ACR",
	"GRAD_INS","GRAD_RU","GRAD_CDF","HMMWV_Avenger","Ikarus","RM70_ACR",
	"KamazRepair","LAV25_HQ","MMT_USMC","2S6M_Tunguska","BMP2_Ambul_CDF","BMP2_CDF","2S6M_Tunguska","BMP2_Gue",
	"BMP2_HQ_CDF","BMP2_HQ_INS","BMP2_INS","M1A1","MLRS","T72_CDF","T72_RU",
    "Ka52","Ka52Black", "Pandur2_ACR", "BVP1_TK_ACR", "BVP1_TK_GUE_ACR", "BRDM2_Desert_ACR", "BRDM2_ACR", "BMP2_ACR",
	"Mi17_rockets_RU","Mi17_TK_EP1","Mi17_UN_CDF_EP1", "BMP2_Des_ACR",
    ...
    "Mi171Sh_rockets_CZ_EP1","UH1H_TK_EP1","Su34","Mi24_D_CZ_ACR","M1114_AGS_ACR","M1114_DSK_ACR"];

...
if (_type == 0) then {
	...
	_car setVehicleInit "nul=[this, 30, 3600, 0, false] execVM 'server\functions\vehicle.sqf'";
	processInitCommands;
...
if (_type == 1) then {
    ...
    _car setpos [getpos _car select 0,getpos _car select 1,0];
	_car setVehicleInit "nul=[this, 30, 0, 0, false] execVM 'server\functions\vehicle.sqf'";
	processInitCommands;
